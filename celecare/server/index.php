...
$access_token = "oy8H4Cwy_dX31bUq-WxWC0RrMvwVG04MaGnuLT57M_ldyYCsSgZs28FugCzEjZdYUZR-KqQvuxEydI0ng0rGDNLKIYKvtEosTv9Oi6CKrMtsgXA0FdJN3DUY6jvX7godODUjAHATIZ";
...
function getPostData($url,$header,$data){
    $ch = curl_init();
    curl_setopt($ch,CURLOPT_URL,$url);
    curl_setopt($ch,CURLOPT_HTTPHEADER,$header);
    curl_setopt($ch,CURLOPT_RETURNTRANSFER,1);
     ...
     },
     {
         ...
         "sub_button":[
             ...
             },
             {
                 "name":"日常查询",
                 "type":"view",
                 "url":"http://mrdaigithub.github.io/celecare/query/pages/index.html"
             }
         ]
     }
     ]
